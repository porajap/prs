...
public class CheckStatusAllFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup = container;
        View _view = inflater.inflate(R.layout.fragment_check_status_all, container, false);

        recyclerView = (RecyclerView) _view.findViewById(R.id.recycler_view_request);
    ...
    private void bindEvents() {
        ...
        //when item in recycler view position <= 1 set swipe_refresh(true)
