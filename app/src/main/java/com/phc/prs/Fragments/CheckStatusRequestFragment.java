...
public class CheckStatusRequestFragment extends Fragment {
    ...
    public CheckStatusRequestFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View _view = inflater.inflate(R.layout.fragment_check_status_request, container, false);
